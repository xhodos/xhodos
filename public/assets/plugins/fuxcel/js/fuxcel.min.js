...
'suffix'`;
  ...
  var FuxcelValidator = class _FuxcelValidator extends Fuxcel {
    ...
    undoValidation(destroyValidation = false) {
      ...
      !!fx(`${validationProps.validationIconField} > *`)?.length ? fx(`${validationProps.validationIconField} > *`).fadeout().then((e) => fx(validationProps.validationField).formValidator.renderMessage(null)) : fx(validationProps.validationField).formValidator.renderMessage(null);
      return this;
    }
    /**
...
Set Timeout:${timeout / 1e3}s`), 408, "timeout") : onError(error, status, statusText);
  ...
  fx.modal = function({ title = null, type = "success", content = "Alert Content", confirmButtonText = null, cancelButtonText = null, html = true, closeOnConfirm = false, onConfirm = null, onCancel = null, onEsc = null } = {}) {
    ...
    const initialModal = FuxcelModal.init({ title, html, content, id: "init", hasFooter: false });
    ...
    if (cancelButtonText || confirmButtonText) {
      ...
      modal.off("click").upon("click", function(e) {
        ...
        fx(".fx-modal-content", modal).hasFocus.then((focused) => {
          if (!focused)
            cancelButtonText ? document.querySelector("#fx-modal-cancel")?.dispatchEvent(FuxcelModal.fxModalCancelButtonClick) : document.querySelector("#fx-modal-confirm")?.dispatchEvent(FuxcelModal.fxModalCancelButtonClick);
          else {
